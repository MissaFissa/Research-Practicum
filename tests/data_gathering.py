...
class DataGathering:
    ...
    def __init__(self):
        ...
        self.n_eff_200_0deg = []
        self.n_eff_400_unscaled_15deg = []
        self.n_eff_400_unscaled_0deg = []
        self.n_eff_200_unscaled_15deg = []
        self.n_eff_200_unscaled_0deg = []
        self.NA = 0.39
        self.n_water = 1.33
        self.n_air = 1.0
        self.t_reference = 6
    ...
    def water_indices(self):

        for i in self.df_water[self.dict_water[0]][0:1]:
    ...
    def effective_index(self):
        ...
        for i in range(400,len(self.df_400)):
            ...
            self.n_eff_400_unscaled_15deg.append(n_eff_400_15deg_unscaled)
            self.n_eff_400_unscaled_0deg.append(n_eff_400_0deg_unscaled)
            ...
            self.n_eff_200_unscaled_15deg.append(n_eff_200_15deg_unscaled)
            self.n_eff_200_unscaled_0deg.append(n_eff_200_0deg_unscaled)
