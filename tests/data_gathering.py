...
print(np.where(data.df_400_experiment[data.dict_400_experiment[0]] == max(data.df_400_experiment[data.dict_400_experiment[0]])))
print(data.df_400_experiment[data.dict_400_experiment[0]][999])