...
axs3[0,0].plot(data.wavelengths_400nm, data.n_eff_positive_400, c='dodgerblue')
axs3[0,1].plot(data.wavelengths_400nm, data.n_eff_negative_400, c='dodgerblue')

axs3[1,0].plot(data.wavelengths_400nm, data.n_eff_positive_200, c='dodgerblue')
axs3[1,1].plot(data.wavelengths_400nm, data.n_eff_negative_200, c='dodgerblue')
...
# axs4[0,0].plot(data.wavelengths, data.R_IL_400_0deg)
# axs4[0,1].plot(data.wavelengths, data.IL_400_6ms_0deg)

# axs4[1,0].plot(data.wavelengths, data.R_IL_200_0deg)
# axs4[1,1].plot(data.wavelengths, data.IL_200_5ms_0deg)

# plt.setp(axs4[0,0], xlim=(400,1100), ylim=(0,0.3))
# plt.setp(axs4[1,0], xlim=(400,1100), ylim=(0,0.3))
