...
axs5[0,0].plot(data.wavelengths_400nm, data.scaled_400[0], c='dodgerblue')
axs5[0,1].plot(data.wavelengths_400nm, data.scaled_400[1], c='dodgerblue')

# axs5[1,0].plot(data.wavelengths_400nm, data.scaled_400[2], c='dodgerblue')
# axs5[1,1].plot(data.wavelengths_400nm, data.scaled_400[3], c='dodgerblue')
...
fig5.suptitle(f' {filename} ', fontsize=20)
plt.tight_layout()
plt.margins(0)
